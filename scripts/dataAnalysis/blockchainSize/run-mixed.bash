...
bash blockchainSize-mixed.bash > 1tpb-1s.log
...
bash blockchainSize-mixed.bash > 4tpb-1s.log
...
bash blockchainSize-mixed.bash > 15tpb-15s.log
...
bash blockchainSize-mixed.bash > 30tpb-30s.log
...
bash blockchainSize-mixed.bash > 60tpb-60s.log
...
bash blockchainSize-mixed.bash > 60tpb-15s.log
...
bash blockchainSize-mixed.bash > 120tpb-30s.log
...
bash blockchainSize-mixed.bash > 240tpb-60s.log
